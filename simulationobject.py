...
def save(self):
    try:
        ...
        print self.move
        print Simulation.save
    self.nc[self.move/Simulation.save] = energyfunc.nativecontact(self.r2, Simulation.nativeparam, Simulation.nsigma2)
...
class Simulation:
    ...
    def loadextend(self,extenddirec):
        ...
        self.setenergy()
        self.energyarray[0]=self.u0
        self.nc[0] = energyfunc.nativecontact(self.r2, Simulation.nativeparam, Simulation.nsigma2)
